[Lambda ORM](../README.md) / [model](../modules/model.md) / GroupBy

# Class: GroupBy

[model](../modules/model.md).GroupBy
...
- [constructor](model.GroupBy.md#constructor)

### Properties

- [children](model.GroupBy.md#children)
- [data](model.GroupBy.md#data)
- [id](model.GroupBy.md#id)
- [index](model.GroupBy.md#index)
- [level](model.GroupBy.md#level)
- [metadata](model.GroupBy.md#metadata)
- [name](model.GroupBy.md#name)
- [parent](model.GroupBy.md#parent)
- [type](model.GroupBy.md#type)

### Methods

- [clone](model.GroupBy.md#clone)
- [eval](model.GroupBy.md#eval)
- [set](model.GroupBy.md#set)
