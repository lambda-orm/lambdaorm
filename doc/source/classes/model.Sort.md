[Lambda ORM](../README.md) / [model](../modules/model.md) / Sort

# Class: Sort

[model](../modules/model.md).Sort
...
- [constructor](model.Sort.md#constructor)

### Properties

- [children](model.Sort.md#children)
- [data](model.Sort.md#data)
- [id](model.Sort.md#id)
- [index](model.Sort.md#index)
- [level](model.Sort.md#level)
- [metadata](model.Sort.md#metadata)
- [name](model.Sort.md#name)
- [parent](model.Sort.md#parent)
- [type](model.Sort.md#type)

### Methods

- [clone](model.Sort.md#clone)
- [eval](model.Sort.md#eval)
- [set](model.Sort.md#set)
