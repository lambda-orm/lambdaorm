...
CREATE TABLE Timezones (GmtOffset INTEGER  ,name VARCHAR(32) NOT NULL ,positionLat DECIMAL(10,4) NOT NULL ,countriesName VARCHAR(80) NOT NULL ,CONSTRAINT Timezones_PK PRIMARY KEY (name));
