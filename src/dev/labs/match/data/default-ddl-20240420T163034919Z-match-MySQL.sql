...
CREATE TABLE Orders (OrderID INTEGER  AUTO_INCREMENT,CustomerID VARCHAR(5) NOT NULL ,EmployeeID INTEGER NOT NULL ,OrderDate DATETIME  ,RequiredDate DATE  ,ShippedDate DATE  ,ShipVia INTEGER  ,Freight DECIMAL(10,4)  ,ShipName VARCHAR(80)  ,ShipAddress VARCHAR(80)  ,ShipCity VARCHAR(80)  ,ShipRegion VARCHAR(80)  ,ShipPostalCode VARCHAR(20)  ,ShipCountry VARCHAR(80)  ,CONSTRAINT Orders_PK PRIMARY KEY (CustomerID,EmployeeID,OrderID,OrderID));
CREATE TABLE Products (ProductID INTEGER  AUTO_INCREMENT,ProductName VARCHAR(80) NOT NULL ,SupplierID INTEGER NOT NULL ,CategoryID INTEGER NOT NULL ,QuantityPerUnit VARCHAR(80)  ,UnitPrice DECIMAL(10,4)  ,UnitsInStock DECIMAL(10,4)  ,UnitsOnOrder DECIMAL(10,4)  ,ReorderLevel DECIMAL(10,4)  ,Discontinued INTEGER  ,CONSTRAINT Products_PK PRIMARY KEY (CategoryID,ProductID,ProductID,SupplierID));
