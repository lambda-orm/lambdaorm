...
class StagePull extends actionDDL_1.StageActionDDL {
    ...
    execute() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.stageModelService.ddl(this.options.stage, 'pull', queries);
            return [];
        });
    }
}
exports.StagePull = StagePull;
