...
exports.QueryUpsertExecutor = void 0;
const queryInsertExecutor_1 = require("./queryInsertExecutor");
class QueryUpsertExecutor extends queryInsertExecutor_1.QueryInsertExecutor {
    upsert(query, data, mapping, dialect, connection) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // insert main entity
            const insertId = yield connection.upsert(mapping, dialect, query, data);
            if (autoIncrement) {
...
exports.QueryUpsertExecutor = QueryUpsertExecutor;
//# sourceMappingURL=queryUpsertExecutor.js.map