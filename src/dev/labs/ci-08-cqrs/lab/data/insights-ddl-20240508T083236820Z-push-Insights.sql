CREATE TABLE IF NOT EXISTS Categories (CategoryID serial,CategoryName VARCHAR(80) NOT NULL ,CONSTRAINT Categories_PK PRIMARY KEY (CategoryID));
...
CREATE TABLE IF NOT EXISTS Products (ProductID serial,ProductName VARCHAR(80) NOT NULL ,CategoryID INTEGER  ,QuantityPerUnit VARCHAR(80)  ,UnitPrice DECIMAL(10,4)  ,CONSTRAINT Products_PK PRIMARY KEY (ProductID));
ALTER TABLE Products ADD CONSTRAINT Products_UK UNIQUE (ProductName);
CREATE TABLE IF NOT EXISTS Orders (OrderID serial,CustomerID VARCHAR(5) NOT NULL ,OrderDate TIMESTAMP  ,CONSTRAINT Orders_PK PRIMARY KEY (OrderID));
CREATE TABLE IF NOT EXISTS "Order Details" (OrderID INTEGER NOT NULL ,ProductID INTEGER NOT NULL ,UnitPrice DECIMAL(10,4)  ,Quantity DECIMAL(10,4)  ,CONSTRAINT "Order Details_PK" PRIMARY KEY (OrderID,ProductID));
