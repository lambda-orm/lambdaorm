...
export class PmPartyRoleReference extends SrbReference {
	refBaseType?: string
	refId?: string
	partyRole?: PrPartyRole
}
export interface QryPmPartyRoleReference extends QrySrbReference {
	refBaseType: string
	refId: string
...
export class PmIndividual {
	...
	partyRoleRef?: PmPartyRoleReference
...
export interface QryPmIndividual {
	...
	partyRoleRef: QryPmPartyRoleReference & OneToMany<QryPmPartyRoleReference> & PmPartyRoleReference
...
export class DbIndividualReference extends SrbReference {
	refType?: string
	refBaseType?: string
	refId?: string
	individual?: PmIndividual
}
export interface QryDbIndividualReference extends QrySrbReference {
	refType: string
	refBaseType: string
	refId: string
	individual: QryPmIndividual & OneToOne<QryPmIndividual> & PmIndividual
}
export class DbOrganizationReference extends SrbReference {
	refType?: string
	refBaseType?: string
	refId?: string
	organization?: PmOrganization
}
export interface QryDbOrganizationReference extends QrySrbReference {
	refType: string
	refBaseType: string
	refId: string
	organization: QryPmOrganization & OneToOne<QryPmOrganization> & PmOrganization
...
export class DbDebtor {
	...
	individualRef?: DbIndividualReference
	organizationRef?: DbOrganizationReference
...
export interface QryDbDebtor {
	...
	individualRef: QryDbIndividualReference & OneToOne<QryDbIndividualReference> & DbIndividualReference
	organizationRef: QryDbOrganizationReference & OneToOne<QryDbOrganizationReference> & DbOrganizationReference
...
export let PmPartyRoleReferences: Queryable<QryPmPartyRoleReference>
...
export let DbOrganizationReferences: Queryable<QryDbOrganizationReference>
