...
describe('delete', () => {
	...
	test('getInfo', () => {
		expect(orm.plan('Categories.delete()',{ stage: 'MySQL' })).toStrictEqual({"entity":"Categories","dialect":"MySQL","source":"MySQL","sentence":"DELETE c FROM Categories AS c WHERE c.CategoryID = ? ","children":[]})
		expect(orm.plan('Categories.delete(entity)',{ stage: 'MySQL' })).toStrictEqual({"entity":"Categories","dialect":"MySQL","source":"MySQL","sentence":"DELETE c FROM Categories AS c WHERE c.CategoryID = ? ","children":[]})
		expect(orm.plan('Categories.delete(p => entity)',{ stage: 'MySQL' })).toStrictEqual({"entity":"Categories","dialect":"MySQL","source":"MySQL","sentence":"DELETE c FROM Categories AS c WHERE c.CategoryID = ? ","children":[]})
		expect(orm.plan('Categories.delete(p => p)',{ stage: 'MySQL' })).toStrictEqual({"entity":"Categories","dialect":"MySQL","source":"MySQL","sentence":"DELETE c FROM Categories AS c WHERE c.CategoryID = ? ","children":[]})
		expect(orm.plan('Categories.delete().filter(p => p.id === id)',{ stage: 'MySQL' })).toStrictEqual({"entity":"Categories","dialect":"MySQL","source":"MySQL","sentence":"DELETE c FROM Categories AS c WHERE c.CategoryID = ? ","children":[]})
		expect(orm.plan('Categories.delete().filter(p => p.id === entity.id)',{ stage: 'MySQL' })).toStrictEqual({"entity":"Categories","dialect":"MySQL","source":"MySQL","sentence":"DELETE c FROM Categories AS c WHERE c.CategoryID = ? ","children":[]})
		expect(orm.plan('Categories.deleteAll()',{ stage: 'MySQL' })).toStrictEqual({"entity":"Categories","dialect":"MySQL","source":"MySQL","sentence":"DELETE c FROM Categories AS c ","children":[]})
		expect(orm.plan('Categories.deleteAll().filter(p=> substring(p.name,1,3) === "cat")',{ stage: 'MySQL' })).toStrictEqual({"entity":"Categories","dialect":"MySQL","source":"MySQL","sentence":"DELETE c FROM Categories AS c WHERE SUBSTR(c.CategoryName,1,3) = 'cat' ","children":[]})
		expect(orm.plan('Orders.details.delete().filter(p => p.orderId === id)',{ stage: 'MySQL' })).toStrictEqual({"entity":"Orders.details","dialect":"MySQL","source":"MySQL","sentence":"DELETE o FROM `Order Details` AS o WHERE o.OrderID = ? ","children":[]})
		expect(orm.plan('Orders.delete().include(p => p.details)',{ stage: 'MySQL' })).toStrictEqual({"entity":"Orders","dialect":"MySQL","source":"MySQL","sentence":"DELETE o FROM Orders AS o WHERE o.OrderID = ? ","children":[{"entity":"Orders.details","dialect":"MySQL","source":"MySQL","sentence":"DELETE o1 FROM `Order Details` AS o1 WHERE (o1.OrderID = ? AND o1.ProductID = ?) ","children":[]}]})
		expect(orm.plan('Orders.delete().filter(p => p.id === id).include(p => p.details)',{ stage: 'MySQL' })).toStrictEqual({"entity":"Orders","dialect":"MySQL","source":"MySQL","sentence":"DELETE o FROM Orders AS o WHERE o.OrderID = ? ","children":[{"entity":"Orders.details","dialect":"MySQL","source":"MySQL","sentence":"DELETE o1 FROM `Order Details` AS o1 WHERE (o1.OrderID = ? AND o1.ProductID = ?) ","children":[]}]})
		expect(orm.plan('Orders.delete().include(p => p.details)',{ stage: 'MySQL' })).toStrictEqual({"entity":"Orders","dialect":"MySQL","source":"MySQL","sentence":"DELETE o FROM Orders AS o WHERE o.OrderID = ? ","children":[{"entity":"Orders.details","dialect":"MySQL","source":"MySQL","sentence":"DELETE o1 FROM `Order Details` AS o1 WHERE (o1.OrderID = ? AND o1.ProductID = ?) ","children":[]}]})
		expect(orm.plan('Orders.details.delete(entity)',{ stage: 'MySQL' })).toStrictEqual({"entity":"Orders.details","dialect":"MySQL","source":"MySQL","sentence":"DELETE o FROM `Order Details` AS o WHERE (o.OrderID = ? AND o.ProductID = ?) ","children":[]})
		expect(orm.plan('Orders.delete(entity).include(p => p.details)',{ stage: 'MySQL' })).toStrictEqual({"entity":"Orders","dialect":"MySQL","source":"MySQL","sentence":"DELETE o FROM Orders AS o WHERE o.OrderID = ? ","children":[{"entity":"Orders.details","dialect":"MySQL","source":"MySQL","sentence":"DELETE o1 FROM `Order Details` AS o1 WHERE (o1.OrderID = ? AND o1.ProductID = ?) ","children":[]}]})
		expect(orm.plan('Orders.details.deleteAll()',{ stage: 'MySQL' })).toStrictEqual({"entity":"Orders.details","dialect":"MySQL","source":"MySQL","sentence":"DELETE o FROM `Order Details` AS o ","children":[]})
	})
})
