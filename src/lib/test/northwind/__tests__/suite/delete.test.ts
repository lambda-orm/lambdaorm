...
describe('delete', () => {
	...
	test('getInfo', () => {
		...
		expect(orm.plan('Categories.deleteAll()',{ stage: 'MySQL' })).toStrictEqual({"entity":"Categories","dialect":"MySQL","source":"MySQL","sentence":"DELETE FROM Categories "})
		...
		expect(orm.plan('Orders.details.deleteAll()',{ stage: 'MySQL' })).toStrictEqual({"entity":"Orders.details","dialect":"MySQL","source":"MySQL","sentence":"DELETE FROM `Order Details` "})
	})
})
