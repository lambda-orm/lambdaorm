...
describe('groupBy', () => {
	...
	test('metadata', () => {
		// expect(orm.metadata('Products.map(p => ({ maxPrice: max(p.price) }))')).toStrictEqual({"classtype":"Sentence","pos":{"ln":0,"col":13},"name":"select","children":[],"type":"any","entity":"Products","columns":[{"name":"maxPrice","type":"any"}],"parameters":[],"constraints":[],"values":[],"defaults":[],"clause":"select","alias":"p"})
		// expect(orm.metadata('Products.map(p => ({ minPrice: min(p.price) }))')).toStrictEqual({"classtype":"Sentence","pos":{"ln":0,"col":13},"name":"select","children":[],"type":"any","entity":"Products","columns":[{"name":"minPrice","type":"any"}],"parameters":[],"constraints":[],"values":[],"defaults":[],"clause":"select","alias":"p"})
		// expect(orm.metadata('Products.map(p => ({ total: sum(p.price) }))')).toStrictEqual({"classtype":"Sentence","pos":{"ln":0,"col":13},"name":"select","children":[],"type":"any","entity":"Products","columns":[{"name":"total","type":"number"}],"parameters":[],"constraints":[],"values":[],"defaults":[],"clause":"select","alias":"p"})
		// expect(orm.metadata('Products.map(p => ({ average: round(avg(p.price), 4) }))')).toStrictEqual({"classtype":"Sentence","pos":{"ln":0,"col":13},"name":"select","children":[],"type":"any","entity":"Products","columns":[{"name":"average","type":"number"}],"parameters":[],"constraints":[],"values":[],"defaults":[],"clause":"select","alias":"p"})
		// expect(orm.metadata('Products.map(p => ({ count: count(1) }))')).toStrictEqual({"classtype":"Sentence","pos":{"ln":0,"col":13},"name":"select","children":[],"type":"any","entity":"Products","columns":[{"name":"count","type":"integer"}],"parameters":[],"constraints":[],"values":[],"defaults":[],"clause":"select","alias":"p"})
		// expect(orm.metadata('Products.map(p => ({ category: p.categoryId, largestPrice: max(p.price) }))')).toStrictEqual({"classtype":"Sentence","pos":{"ln":0,"col":13},"name":"select","children":[],"type":"any","entity":"Products","columns":[{"name":"category","type":"integer"},{"name":"largestPrice","type":"any"}],"parameters":[],"constraints":[],"values":[],"defaults":[],"clause":"select","alias":"p"})
		// expect(orm.metadata('Products.map(p => ({ category: p.category.name, largestPrice: max(p.price) }))')).toStrictEqual({"classtype":"Sentence","pos":{"ln":0,"col":13},"name":"select","children":[],"type":"any","entity":"Products","columns":[{"name":"category","type":"string"},{"name":"largestPrice","type":"any"}],"parameters":[],"constraints":[],"values":[],"defaults":[],"clause":"select","alias":"p"})
		// expect(orm.metadata('Products.filter(p => p.id === id).map(p => ({ name: p.name, source: p.price, result: abs(p.price) }))')).toStrictEqual({"classtype":"Sentence","pos":{"ln":0,"col":38},"name":"select","children":[],"type":"any","entity":"Products","columns":[{"name":"name","type":"string"},{"name":"source","type":"decimal"},{"name":"result","type":"number"}],"parameters":[{"name":"id","type":"integer"}],"constraints":[],"values":[],"defaults":[],"clause":"select","alias":"p"})
		// expect(orm.metadata('Products.having(p => max(p.price) > 100).map(p => ({ category: p.category.name, largestPrice: max(p.price) }))')).toStrictEqual({"classtype":"Sentence","pos":{"ln":0,"col":45},"name":"select","children":[],"type":"any","entity":"Products","columns":[{"name":"category","type":"string"},{"name":"largestPrice","type":"any"}],"parameters":[],"constraints":[],"values":[],"defaults":[],"clause":"select","alias":"p"})
		// expect(orm.metadata('Orders.details.map(p => ({ subTotal: sum((p.unitPrice * p.quantity * (1 - p.discount / 100)) * 100) })).sort(p => p.subTotal)')).toStrictEqual({"classtype":"Sentence","pos":{"ln":0,"col":109},"name":"select","children":[],"type":"any","entity":"Orders.details","columns":[{"name":"subTotal","type":"number"}],"parameters":[],"constraints":[],"values":[],"defaults":[],"clause":"select","alias":"o"})
		// expect(orm.metadata('Products.having(p => max(p.price) > 100).map(p => ({ category: p.category.name, largestPrice: max(p.price) })).sort(p => desc(p.largestPrice))')).toStrictEqual({"classtype":"Sentence","pos":{"ln":0,"col":116},"name":"select","children":[],"type":"any","entity":"Products","columns":[{"name":"category","type":"string"},{"name":"largestPrice","type":"any"}],"parameters":[],"constraints":[],"values":[],"defaults":[],"clause":"select","alias":"p"})
		// expect(orm.metadata('Products.filter(p => p.price > 5).having(p => max(p.price) > 50).map(p => ({ category: p.category.name, largestPrice: max(p.price) })).sort(p => desc(p.largestPrice))')).toStrictEqual({"classtype":"Sentence","pos":{"ln":0,"col":140},"name":"select","children":[],"type":"any","entity":"Products","columns":[{"name":"category","type":"string"},{"name":"largestPrice","type":"any"}],"parameters":[],"constraints":[],"values":[],"defaults":[],"clause":"select","alias":"p"})
	})
	test('getInfo', () => {
