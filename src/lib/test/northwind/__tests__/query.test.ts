...
describe('Sentences', () => {
	...
	test('query 6', async () => {
		...
		let SqlServer = orm.plan(expression,{stage:'SqlServer'})
		expect(SqlServerExpected).toStrictEqual(SqlServer)
		const MongoDBExpected = {"entity":"Products","dialect":"MongoDB","source":"MongoDB","sentence":"[{\"$lookup\":{\"from\":\"Categories\",\"localField\":\"CategoryID\",\"foreignField\":\"_id\",\"as\":\"c\"}},{\"$project\":{\"_id\":0,\"category\":{\"$arrayElemAt\":[\"$c.CategoryName\",0]}}},{\"$sort\":{\"category\":1}}]"}
		let MongoDB = orm.plan(expression,{stage:'MongoDB'})
		expect(MongoDBExpected).toStrictEqual(MongoDB)
	...
	test('query 7', async () => {
		...
		let SqlServer = orm.plan(expression,{stage:'SqlServer'})
		expect(SqlServerExpected).toStrictEqual(SqlServer)
		const MongoDBExpected = {"entity":"Products","dialect":"MongoDB","source":"MongoDB","sentence":"[{\"$lookup\":{\"from\":\"Categories\",\"localField\":\"CategoryID\",\"foreignField\":\"_id\",\"as\":\"c\"}},{\"$project\":{\"_id\":0,\"name\":\"$ProductName\",\"category\":{\"$arrayElemAt\":[\"$c.CategoryName\",0]}}},{\"$sort\":{\"category\":1,\"ProductName\":1}}]"}
		let MongoDB = orm.plan(expression,{stage:'MongoDB'})
		expect(MongoDBExpected).toStrictEqual(MongoDB)
	...
	test('query 8', async () => {
		...
		let SqlServer = orm.plan(expression,{stage:'SqlServer'})
		expect(SqlServerExpected).toStrictEqual(SqlServer)
		const MongoDBExpected = {"entity":"Products","dialect":"MongoDB","source":"MongoDB","sentence":"[{\"$lookup\":{\"from\":\"Categories\",\"localField\":\"CategoryID\",\"foreignField\":\"_id\",\"as\":\"c\"}},{\"$project\":{\"_id\":0,\"category\":{\"$arrayElemAt\":[\"$c.CategoryName\",0]},\"name\":\"$ProductName\",\"quantity\":\"$QuantityPerUnit\",\"inStock\":\"$UnitsInStock\"}},{\"$sort\":{\"ProductName\":1}}]"}
		let MongoDB = orm.plan(expression,{stage:'MongoDB'})
		expect(MongoDBExpected).toStrictEqual(MongoDB)
	...
	test('query 14', async () => {
		...
		let SqlServer = orm.plan(expression,{stage:'SqlServer'})
		expect(SqlServerExpected).toStrictEqual(SqlServer)
		const MongoDBExpected = {"entity":"Products","dialect":"MongoDB","source":"MongoDB","sentence":"[{\"$lookup\":{\"from\":\"Categories\",\"localField\":\"CategoryID\",\"foreignField\":\"_id\",\"as\":\"c\"}},{\"$project\":{\"_id\":0,\"category\":{\"$arrayElemAt\":[\"$c.CategoryName\",0]},\"name\":\"$ProductName\",\"quantity\":\"$QuantityPerUnit\",\"inStock\":\"$UnitsInStock\"}},{\"$sort\":{\"category\":1}},{\"$skip\":0},{\"$limit\":1} ]"}
		let MongoDB = orm.plan(expression,{stage:'MongoDB'})
		expect(MongoDBExpected).toStrictEqual(MongoDB)
