...
describe('Metadata', () => {
	test('function abs', async () => {
		...
		const metadataExpected :any= {"classtype":"Sentence","pos":{"ln":0,"col":38},"name":"select","children":[],"type":"any","entity":"Products","columns":[{"name":"name","type":"string"},{"name":"source","type":"number"},{"name":"result","type":"number"}],"parameters":[{"name":"id","type":"any"}],"constraints":[],"values":[],"defaults":[],"clause":"select","alias":"p"}
	...
	test('function cos', async () => {
		...
		const parametersExpected:any = [{"name":"id","type":"any"}]
		const metadataExpected :any= {"classtype":"Sentence","pos":{"ln":0,"col":38},"name":"select","children":[],"type":"any","entity":"Products","columns":[{"name":"name","type":"string"},{"name":"source","type":"integer"},{"name":"result","type":"number"}],"parameters":[{"name":"id","type":"any"}],"constraints":[],"values":[],"defaults":[],"clause":"select","alias":"p"}
		const constraintsExpected :any= {"entity":"Products","constraints":[]}
		const model = orm.model(expression)
		const parameters = orm.parameters(expression)
		const constraints = orm.constraints(expression)
	...
	test('function log', async () => {
		...
		const parametersExpected:any = [{"name":"id","type":"any"}]
		const metadataExpected :any= {"classtype":"Sentence","pos":{"ln":0,"col":38},"name":"select","children":[],"type":"any","entity":"Products","columns":[{"name":"name","type":"string"},{"name":"m","type":"integer"},{"name":"n","type":"integer"},{"name":"result","type":"number"}],"parameters":[{"name":"id","type":"any"}],"constraints":[],"values":[],"defaults":[],"clause":"select","alias":"p"}
		const constraintsExpected :any= {"entity":"Products","constraints":[]}
		const model = orm.model(expression)
		const parameters = orm.parameters(expression)
		const constraints = orm.constraints(expression)
