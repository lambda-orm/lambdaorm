...
describe('bitwise', () => {
	...
	test('getInfo', () => {
		expect(orm.plan('Countries.filter(p=> p.iso3=="BRA").first(p=> {result: p.longitude & 1 })',{ stage: 'stage1' })).toStrictEqual({"entity":"Countries","dialect":"MySQL","source":"dataSource1","sentence":"SELECT c.longitude & 1 AS result FROM Countries c  WHERE c.iso3 = 'BRA' ORDER BY result asc  LIMIT 0,1 ","children":[]})
		expect(orm.plan('Countries.filter(p=> p.iso3=="BRA").first(p=> {result: p.longitude | 1 })',{ stage: 'stage1' })).toStrictEqual({"entity":"Countries","dialect":"MySQL","source":"dataSource1","sentence":"SELECT c.longitude | 1 AS result FROM Countries c  WHERE c.iso3 = 'BRA' ORDER BY result asc  LIMIT 0,1 ","children":[]})
		expect(orm.plan('Countries.filter(p=> p.iso3=="BRA").first(p=> {result: ~ p.longitude })',{ stage: 'stage1' })).toStrictEqual({"entity":"Countries","dialect":"MySQL","source":"dataSource1","sentence":"SELECT ~ c.longitude AS result FROM Countries c  WHERE c.iso3 = 'BRA' ORDER BY result asc  LIMIT 0,1 ","children":[]})
		expect(orm.plan('Countries.filter(p=> p.iso3=="BRA").first(p=> {result: p.longitude << 1 })',{ stage: 'stage1' })).toStrictEqual({"entity":"Countries","dialect":"MySQL","source":"dataSource1","sentence":"SELECT c.longitude << 1 AS result FROM Countries c  WHERE c.iso3 = 'BRA' ORDER BY result asc  LIMIT 0,1 ","children":[]})
		expect(orm.plan('Countries.filter(p=> p.iso3=="BRA").first(p=> {result: p.longitude ^ 1 })',{ stage: 'stage1' })).toStrictEqual({"entity":"Countries","dialect":"MySQL","source":"dataSource1","sentence":"SELECT c.longitude ^ 1 AS result FROM Countries c  WHERE c.iso3 = 'BRA' ORDER BY result asc  LIMIT 0,1 ","children":[]})
		expect(orm.plan('Countries.filter(p=> p.iso3=="BRA").first(p=> {result: p.longitude >> 1 })',{ stage: 'stage1' })).toStrictEqual({"entity":"Countries","dialect":"MySQL","source":"dataSource1","sentence":"SELECT c.longitude >> 1 AS result FROM Countries c  WHERE c.iso3 = 'BRA' ORDER BY result asc  LIMIT 0,1 ","children":[]})
	})
