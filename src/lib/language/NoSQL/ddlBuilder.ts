...
export class NoSqlDDLBuilder extends LanguageDDLBuilder {
	...
	public createSequence (entity: EntityMapping): Query | undefined {
		...
		return new Query({ action: SentenceAction.createSequence, dialect: this.source.dialect, source: this.source.name, sentence: sentence, entity: entity.name })
	}
	...
	public createIndex (entity: EntityMapping, index: Index): Query | undefined {
		...
		return new Query({ action: SentenceAction.createIndex, dialect: this.source.dialect, source: this.source.name, sentence: sentence, entity: entity.name })
	}
	...
	public addPk (entity: EntityMapping, primaryKey: string[]): Query | undefined {
		...
		return new Query({ action: SentenceAction.addPk, dialect: this.source.dialect, source: this.source.name, sentence: sentence, entity: entity.name })
	}
	...
	public addUk (entity: EntityMapping, uniqueKey: string[]): Query | undefined {
		...
		return new Query({ action: SentenceAction.addUk, dialect: this.source.dialect, source: this.source.name, sentence: sentence, entity: entity.name })
	}
	...
	public dropPk (entity: EntityMapping): Query | undefined {
		...
		return new Query({ action: SentenceAction.dropPk, dialect: this.source.dialect, source: this.source.name, sentence: sentence, entity: entity.name })
	}

	public dropUk (entity: EntityMapping): Query | undefined {
		// https://www.MongoDB.com/docs/manual/reference/method/db.collection.dropIndex/
		const sentence = this.dialect.delimiter(entity.mapping + '_UK')
		return new Query({ action: SentenceAction.dropUk, dialect: this.source.dialect, source: this.source.name, sentence: sentence, entity: entity.name })
	}
	...
	public dropIndex (entity: EntityMapping, index: Index): Query | undefined {
		...
		return new Query({ action: SentenceAction.dropIndex, dialect: this.source.dialect, source: this.source.name, sentence: sentence, entity: entity.name })
	}
	...
	public dropSequence (entity: EntityMapping): Query | undefined {
		...
		return new Query({ action: SentenceAction.dropSequence, dialect: this.source.dialect, source: this.source.name, sentence: sentence, entity: entity.name })
	}
}
