...
import {
	IModelConfigService, IMappingConfigService, IMappingsConfigService, IViewConfigService,
...
export class ModelConfigService extends ModelConfigServiceBase<Entity, Property> implements IModelConfigService {
...
export class MappingConfigService extends ModelConfigServiceBase<EntityMapping, PropertyMapping> implements IMappingConfigService {
...
export class MappingsConfigService implements IMappingsConfigService {
...
export class ViewConfigService implements IViewConfigService {
	private view: View
...
export class ViewsConfigService implements IViewsConfigService {
	public views: View[]
...
export class StageConfigService implements IStageConfigService {
	public stages: Stage[]
...
export class SchemaService implements ISchemaService {
	public source: IDataSourceConfigService
	public model: IModelConfigService
	public mapping: IMappingsConfigService
	public stage: IStageConfigService
	public view: IViewsConfigService
