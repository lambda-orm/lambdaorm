...
import {
	...
	, Insert, Update, Delete, Query, SintaxisError, SchemaError, source, BulkInsert, IMappingConfigService, IDialectService
} from '../../domain'
...
export abstract class DmlBuilder {
	...
	constructor (source: source, mapping: IMappingConfigService, dialect: IDialectService, expressions: IExpressions) {
		this.source = source
