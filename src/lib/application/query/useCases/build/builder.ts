...
import { SentenceService, LanguagesService, SchemaService, ViewConfigService } from '../../..'

// eslint-disable-next-line padded-blocks
export class QueryBuilder {

	// eslint-disable-next-line no-useless-constructor
	constructor (private readonly sentenceService: SentenceService, private readonly schema: SchemaService, private readonly languages: LanguagesService) {}
