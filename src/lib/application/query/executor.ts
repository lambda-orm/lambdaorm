...
import {
	SentenceAction, Data, QueryOptions, ExecutionError, Query, Include, RelationType, ValidationError, EntityMapping,
...
class QuerySelectExecutor {
	...
	public async select (query: Query, data: Data, mapping: IMappingConfigService, dialect: IDialectService, connection: ConnectionPort): Promise<any> {
	...
	private async selectIncludes (query: Query, data: Data, mainResult: any, dialect: IDialectService, connection: ConnectionPort): Promise<any> {
...
class QueryInsertExecutor {
	...
	public async insert (query: Query, data: Data, mapping: IMappingConfigService, dialect: IDialectService, connection: ConnectionPort): Promise<any> {
	...
	private async insertIncludeBefore (query: Query, data: Data, dialect: IDialectService): Promise<any> {
		for (const include of query.includes) {
			if (!include.relation.composite || !dialect.solveComposite) {
	...
	private async insertIncludeAfter (query: Query, data: Data, dialect: IDialectService): Promise<any> {
		for (const include of query.includes) {
			if (!include.relation.composite || !dialect.solveComposite) {
				const relation = data.get(include.relation.name)
...
class QueryBulkInsertExecutor {
	...
	public async bulkInsert (query: Query, data: Data, mapping: IMappingConfigService, dialect: IDialectService, connection: ConnectionPort): Promise<any[]> {
		const entity = mapping.getEntity(query.entity) as EntityMapping
	...
	private async bulkInsertIncludesBefore (query: Query, data: Data, entity: EntityMapping, dialect: IDialectService): Promise<void> {
		for (const include of query.includes) {
			if (!include.relation.composite || !dialect.solveComposite) {
	...
	private async bulkInsertIncludesAfter (query: Query, data: Data, mapping: IMappingConfigService, dialect: IDialectService): Promise<void> {
		for (const p in query.includes) {
			const include = query.includes[p]
			if (!include.relation.composite || !dialect.solveComposite) {
	...
	private async _chunkInsert (query: Query, entity: EntityMapping, chunk: any[], mapping: IMappingConfigService, dialect: IDialectService, connection: ConnectionPort): Promise<any[]> {
		// solve default properties
		if (entity.hadDefaults) {
...
class QueryUpdateExecutor {
	...
	public async update (query: Query, data: Data, mapping: IMappingConfigService, dialect: IDialectService, connection: ConnectionPort): Promise<number> {
...
class QueryDeleteExecutor {
	...
	public async delete (query: Query, data: Data, mapping: IMappingConfigService, dialect: IDialectService, connection: ConnectionPort): Promise<number> {
