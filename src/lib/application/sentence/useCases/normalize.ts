...
import { helper, SchemaService } from '../..'
import { Entity, Field, Relation, SchemaError, SintaxisError } from '../../../domain'
...
export class SentenceNormalizer {
	...
	private normalizeOperand (operand: Operand): void {
		...
		} else if (operand.type === OperandType.Const && operand.returnType !== undefined && operand.returnType.primitive === Primitive.boolean) {
