...
import {
	SentenceAction, Property, Behavior, Constraint, SintaxisError, Entity,
...
class SentenceSolveConstraints {
	...
	private modelConfig: IModelConfigService
	private expressions: IExpressions

	constructor (modelConfig: IModelConfigService, helper: SentenceHelper, expressions: IExpressions) {
...
class SentenceSolveBehaviors {
	...
	constructor (modelConfig: IModelConfigService, helper: SentenceHelper) {
		this.modelConfig = modelConfig
		this.helper = helper
	}
