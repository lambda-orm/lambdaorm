const {Context,Operand,Constant,Variable} = require("./base.js");
...
class DefaultLanguage extends Language
{
    ...
    createOperand(name,type,children){
        if ( type == 'const')
            ...
            return new KeyValue(name,this._name,children);
        else if ( type == 'array')
            return new Array(name,this._name,children);
        else if ( type == 'obj')
            return new Object(name,this._name,children);
        else if ( type == 'oper')
            ...
            return  new Block(name,this._name,children);
        else
    ...
    createOperator(name,children){
        try{
            ...
            if(metadata.custom)                   
                ...
                return new Operator(name,this._name,children,metadata.function);
        }
        catch(error){
    ...
    createFunctionRef(name,children){
        try{          
            ...
            if(metadata.custom)                 
                ...
                return new FunctionRef(name,this._name,children,metadata.function);
        }
        catch(error){
    ...
    createArrowFunction(name,children){
        try{           
            ...
            if(metadata['custom']){                    
                ...
                return new ArrowFunction(name,this._name,children,_function);
            }
        } 
        catch(error){
