...
module.exports = (async function() {
    if(!exp){
        ...
        exp.addLanguage(new SqlLanguage());
        let ormConfig = await ConfigExtends.apply('lib/config/language/sql');        
        exp.addLibrary({language:'sql',name:'sql',variants:ormConfig.variants});        
